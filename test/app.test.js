...
describe("Server Routes", () => {
    ...
    describe("GET /pokemon - pokemon info page", () => {
        ...
        beforeEach(() => {
            pokeStub = sinon
                .stub(pokeUtil, "getPokemon")
                .resolves(POKEMON_DATA);
        });
        ...
        it("/pokemon?name=pokemonName should render pokemon types", async () => {
            ...
            const dataArr = POKEMON_DATA.types;
            const result = dataArr.some((val) => typeEl.includes(val));

            // document.querySelector('[data-test-id="types"]');
